...
class MiniSearch {
    ...
    addToIndex(shortDocumentId, document, added) {
        var _a;
        ...
        for (const field of fields) {
            ...
            uniqueTerms.delete('');
            if (((_a = this._fieldLength.get(shortDocumentId)) === null || _a === void 0 ? void 0 : _a[fieldId]) != null) {
    ...
    removeFromIndex(shortId, document, removed) {
        var _a;
        ...
        for (const field of fields) {
            ...
            const uniqueTerms = new Set(tokens);
            uniqueTerms.delete('');
            if (((_a = this._fieldLength.get(shortId)) === null || _a === void 0 ? void 0 : _a[fieldId]) == null) {
     ...
     * @ignore
     */
    addFieldLength(documentId, fieldId, count, length, added) {
     ...
     * @ignore
     */
    removeFieldLength(documentId, fieldId, count, length, removed = true) {
        const fieldLengths = this._fieldLength.get(documentId);
        fieldLengths === null || fieldLengths === void 0 ? true : delete fieldLengths[fieldId];
        if (count === 1) {
